...
if ( ! function_exists( 'ot_type_posts_search' ) ) {
  ...
  function ot_type_posts_search( $args = array() ) {
	...
	if ($field_post_type == '') {
     	...
     	echo '<input type="hidden" name="c5-post-type" value="'.$field_post_type.'" />';
     	echo '<div class="c5-articles-wrap"><p>Choose items:</p><select class="c5-posts-select-post-type c5-screen-'.$screen_base.'" name="c5-post-type" id="c5-post-type">';
