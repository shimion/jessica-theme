...
class C5AB_image extends C5_Widget {
	...
	function shortcode($atts,$content) {
		    ...
		    $data = '<div class="c5ab-image-wrap ' . $atts['align'] . '">';
		    ...
		    $data .= '<a href="'.$atts['link'].'" target="_blank"><img src="' . $image_url[0] . '" width="' . $image_url[1] . '" height="' . $image_url[2] . '" class="'.$atts['class'].'" alt="'.$atts['caption'].'" /></a>';
		    	...
		    	$data .= '<img src="' . $image_url[0] . '" width="' . $image_url[1] . '" height="' . $image_url[2] . '" class="c5ab_popup '.$atts['class'].'" alt="'.$atts['caption'].'" />';
		    	
		    	$data .= '</a>';
		    }else {
		    	$data .= '<img src="' . $image_url[0] . '" width="' . $image_url[1] . '" height="' . $image_url[2] . '" alt="'.$atts['caption'].'" class="'.$atts['class'].'" />';
		    }
		    if($atts['caption']!=''){
