...
<div class="c5ab-panel-container clearfix">
	...
	<div class="float-left">
		<span class="c5ab-load-button c5ab-load-template c5abf-down-open"><?php _e('Load Template','c5ab') ?>
		...
		<!--
		<span class="c5ab-load-button c5ab-load-macros"><i class="fa fa-plus"></i><?php _e('Macros','c5ab') ?></span>
		-->
		<?php 
		...
		<span class="c5ab-load-button c5ab-load-import" data-post-id="<?php echo $post_id; ?>"><i class="fa fa-download"></i><?php _e('Import/Export','c5ab') ?></span>
