...
class Widget_Data {
	...
	*/
	public static function add_admin_menus() {
		// export
		$export_page = add_submenu_page( 'c5_theme_welcome' ,'Widget Export', 'Widget Export', 'manage_options', 'widget-settings-export', array( __CLASS__, 'c5_export_settings_page' ) );
		//import
		$import_page = add_submenu_page( 'c5_theme_welcome' ,'Widget Import', 'Widget Import', 'manage_options', 'widget-settings-import', array( __CLASS__, 'c5_import_settings_page' ) );
		...
		function widget_import_enqueue($hook){
			...
			wp_enqueue_style( 'widget_data', C5_FW_URL . 'widget-import-export/widget-data.css' );
			wp_enqueue_script( 'widget_data', C5_FW_URL . 'widget-import-export/widget-data.js', array( 'jquery', 'wp-ajax-response' ) );
