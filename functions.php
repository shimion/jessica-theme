...
function c5_import_admin_js($hook) {
    ...
    wp_enqueue_script( 'c5ab-flexslider', C5BP_extra_uri . 'js/jquery.flexslider-min.js', array(), '2.5', true );

    wp_enqueue_style( 'c5-admin-ss', get_template_directory_uri() . '/library/css/admin.css' );
    wp_enqueue_script( 'admin-code125-js', get_template_directory_uri() . '/library/js/js-admin.js', array( 'jquery' ), '', true );
